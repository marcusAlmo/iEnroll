...
def generate_role_mapping(cursor, user_ids, role, assigned_by):
    insert_query = """
    INSERT INTO enrollment.role_mapping (user_id, role, assigned_by)
    VALUES (%s, %s, %s)
...
class UserGenerator:
    ...
    def generate_admin_user(self):
        ...
        generate_role_mapping(self.cursor, user_ids, 'ADM')
