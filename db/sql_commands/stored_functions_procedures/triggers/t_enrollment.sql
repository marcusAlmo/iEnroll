...
CREATE TRIGGER t_update_permission
    ...
    FOR EACH ROW EXECUTE FUNCTION system.fn_restrict_update();
...
CREATE TRIGGER t_update_user_role
    ...
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_user_role_update();

-- user update trigger
CREATE TRIGGER t_update_user
    BEFORE UPDATE ON enrollment.user
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_user_update();
...
CREATE TRIGGER t_update_application_attachment
    ...
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_update_application_attachment();

-- school update trigger
CREATE TRIGGER t_update_school
    BEFORE UPDATE ON enrollment.school
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_school_update();
...
CREATE TRIGGER t_update_student_enrollment
    ...
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_update_student_enrollment();
...
CREATE TRIGGER t_update_grade_level_offered
    ...
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_grade_level_offered_update();

-- grade_section_type update trigger
CREATE TRIGGER t_update_grade_section_program
    BEFORE UPDATE ON enrollment.grade_section_program
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_grade_section_type_update();
...
CREATE TRIGGER t_update_enrollment_requirement
    ...
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_enrollment_requirement_update();
...
CREATE TRIGGER t_update_enrollment_schedule
    ...
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_enrollment_schedule_update();

-- grade_section update trigger
CREATE TRIGGER t_update_grade_section
    BEFORE UPDATE ON enrollment.grade_section
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_grade_section_update();
...
CREATE TRIGGER t_update_school_subscription
    ...
    FOR EACH ROW EXECUTE FUNCTION enrollment.fn_school_subscription_update();
