...
ALTER TABLE system.grade_level
    ADD CONSTRAINT fk_grade_level_academic_level_code FOREIGN KEY (academic_level_code) REFERENCES system.academic_level(academic_level_code) ON UPDATE CASCADE ON DELETE CASCADE;
