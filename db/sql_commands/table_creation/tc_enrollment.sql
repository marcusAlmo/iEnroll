...
CREATE TABLE IF NOT EXISTS enrollment.grade_level_offered (
    grade_level_offered_id INT GENERATED ALWAYS AS IDENTITY,
    school_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS enrollment.enrollment_requirement (
    requirement_id INT NOT NULL GENERATED ALWAYS AS IDENTITY,
    ...
    constraint uq_enrollment_requirement UNIQUE (grade_section_program_id, name)
);

-- enrollment_fee
CREATE TABLE IF NOT EXISTS enrollment.enrollment_fee (
    fee_id INT GENERATED ALWAYS AS IDENTITY,
    grade_section_program_id INT NOT NULL,
    ...
    constraint uq_enrollment_fee UNIQUE (grade_section_program_id, name),
