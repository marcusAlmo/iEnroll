  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-10 font-inter text-primary ">
            <div className="bg-container_1 rounded-xl shadow-md border-2 h-[537px] max-h-auto mt-10">
                <h1 className="mt-5 font-bold text-2xl md:text-4xl text-center">FREE TRIAL</h1>
                <div className="mt-4 inline-flex items-center rounded-full text-xs font-inter font-bold px-3 py-1 relative">
                ...
                <div className="text-sm font-regular  text-center inline-block px-12 p-2 mt-8 ">
                    Explore the platform with limited features. Perfect for getting started and experiencing the basics.
                </div>
            
                <button className="text-accent border-2 border-accent text-base px-18 py-2 rounded-lg shadow-lg mt-11 cursor-pointer"
            ...
            <div className="bg-container_1 rounded-xl shadow-lg border-2 box-border h-[577.5px] ">          
                ...
                <div className="w-full px-10">
                    ...
                    <div>
                        <ul className="text-sm font-medium flex-col space-y-2 -mt-4">
                            {Perks_1.map((item) => (
            ...
            <div className="bg-container_1 rounded-xl shadow-md border-2 h-[537px] max-h-auto mt-10 px-10 w-full">
                <div className="mt-4 text-left w-full">
                    <h1 className="font-semibold text-xl">
                        School Plan
                    </h1>
