...
const Home: React.FC = () => {
  ...
  return (
    <div>
      <MainNav />
      <div className="w-full min-h-screen flex flex-col items-center text-center text-primary font-semibold relative bg-background">
        <h1 className="text-3xl md:text-4xl mt-20">Pick your perfect plan</h1>
        ...
        <PricingList scrollToContact={scrollToContact} />
        <div className="w-full mt-12" ref={contactRef}>
          <ContactSection />
        </div>
      </div>
      <Footer />
