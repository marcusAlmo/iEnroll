...
const SubNavIndex: React.FC<{ activeTab: string; setActiveTab: (tab: string) => void }> = ({ activeTab, setActiveTab }) => {
  const subNavItems = [
    { label: "Enrollment Breakdown", value: "enrollment-breakdown" },
    { label: "Enrollment Trend", value: "enrollment-trend" },
    { label: "Enrollment Count", value: "enrollment-count" },
    { label: "Plan Capacity", value: "plan-capacity" },
